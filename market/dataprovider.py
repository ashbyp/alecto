...
class DataProvider(Protocol):
    ...
    def get_supported_currency_pairs(self) -> list[tuple[str, str]]:
        ...

    def get_currency_info(self, ccy: str):
        ...

    def get_currency_pair_info(self, ccy_pair: tuple[str, str]):
        ...

    def get_last_price(self, ccy_pair: tuple[str, str]) -> float:
        ...
